...
class S {
  ...
  /// `Ещё один вид теста Купера на силовую выносливость, также не менее распространенный (изначально созданный для военнослужащих армии США, но также используемый спорстменами и военнослужащими других стран, включая РФ), включает в себя 4 повтора следующего комплекса упражнений: делаем 10 отжиманий и остаёмся в упоре лёжа; опираясь на руки прыжком ноги подносим к рукам в упор присев и потом обратно 10 раз; переворачиваемся на спину и 10 раз вынос ног за голову (упражнение выполняется лёжа на спине); 10 подпрыгиваний со сменой ног и касаясь коленом земли.`
