...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function> {
    "Brzycki" : MessageLookupByLibrary.simpleMessage("Бржицки"),
    "Epley" : MessageLookupByLibrary.simpleMessage("Эпли"),
    "Lander" : MessageLookupByLibrary.simpleMessage("Ландер"),
    "Lombardi" : MessageLookupByLibrary.simpleMessage("Ломбарди"),
    "Mayhew" : MessageLookupByLibrary.simpleMessage("Мэхью"),
    ...
    "absiMean" : MessageLookupByLibrary.simpleMessage("Средний ABSI людей вашего пола и возраста"),
    ...
    "absiRisk" : MessageLookupByLibrary.simpleMessage("Риск преждевременной смерти"),
    "absiRisk1" : MessageLookupByLibrary.simpleMessage("Очень низкий."),
    "absiRisk2" : MessageLookupByLibrary.simpleMessage("Низкий."),
    "absiRisk3" : MessageLookupByLibrary.simpleMessage("Средний."),
    "absiRisk4" : MessageLookupByLibrary.simpleMessage("Высокий."),
    "absiRisk5" : MessageLookupByLibrary.simpleMessage("Очень выскокий."),
    "absiWaistCircumference" : MessageLookupByLibrary.simpleMessage("Объём талии"),
    "absiWaistCircumferenceValidation" : MessageLookupByLibrary.simpleMessage("Пожалуйста, введите окружность талии."),
    ...
    "bfpPageTitle" : MessageLookupByLibrary.simpleMessage("Процент жира в теле (BFP)"),
    ...
    "bmi16_18" : MessageLookupByLibrary.simpleMessage("Недостаточная (дефицит) масса тела."),
    "bmi18_25" : MessageLookupByLibrary.simpleMessage("Нормальная масса тела."),
    "bmi25_30" : MessageLookupByLibrary.simpleMessage("Избыточная масса тела (1 степень)."),
    "bmi30_35" : MessageLookupByLibrary.simpleMessage("Ожирение (2a степень)."),
    "bmi35_40" : MessageLookupByLibrary.simpleMessage("Выраженное ожирение (2b степень)."),
    "bmi40" : MessageLookupByLibrary.simpleMessage("Резко выраженное, морбидное ожирение (3 степень)."),
    "bmiHeight" : MessageLookupByLibrary.simpleMessage("Ваш рост"),
    "bmiHeightValidation" : MessageLookupByLibrary.simpleMessage("Пожалуйста, введите ваш рост"),
    "bmiPageDesc" : MessageLookupByLibrary.simpleMessage("Расчитайте индекс массы тела (методика ВОЗ)."),
    "bmiPageTitle" : MessageLookupByLibrary.simpleMessage("Индекс массы тела (BMI)"),
    "bmiWeight" : MessageLookupByLibrary.simpleMessage("Ваш вес"),
    "bmiWeightValidation" : MessageLookupByLibrary.simpleMessage("Пожалуйста, введите ваш вес"),
    ...
    "cooperDistanse" : MessageLookupByLibrary.simpleMessage("Дистанция"),
    "cooperDistanseValidation" : MessageLookupByLibrary.simpleMessage("Пожалуйста, введите дистанцию."),
    "cooperExcellent" : MessageLookupByLibrary.simpleMessage("Отлично"),
    "cooperGood" : MessageLookupByLibrary.simpleMessage("Хорошо"),
    "cooperMark" : MessageLookupByLibrary.simpleMessage("Оценка"),
    ...
    "cooperPageTitle" : MessageLookupByLibrary.simpleMessage("Тест Купера + VO max"),
    "cooperStrongMinutes" : MessageLookupByLibrary.simpleMessage("Количество целых минут на выполнение 4-х циклов"),
    "cooperStrongMinutesValidation" : MessageLookupByLibrary.simpleMessage("Пожалуйста, введите число."),
    "cooperStrongPageDesc" : MessageLookupByLibrary.simpleMessage("Ещё один вид теста Купера на силовую выносливость, также не менее распространенный (изначально созданный для военнослужащих армии США, но также используемый спорстменами и военнослужащими других стран, включая РФ), включает в себя 4 повтора следующего комплекса упражнений:\n\n – делаем 10 отжиманий и остаёмся в упоре лёжа;\n – опираясь на руки прыжком ноги подносим к рукам в упор присев и потом обратно 10 раз;\n – переворачиваемся на спину и 10 раз вынос ног за голову (упражнение выполняется лёжа на спине);\n – 10 подпрыгиваний со сменой ног и касаясь коленом земли."),
    "cooperStrongPageTitle" : MessageLookupByLibrary.simpleMessage("Тест Купера на силовую выносливость"),
    ...
    "homePageBody" : MessageLookupByLibrary.simpleMessage("Физическая форма"),
    ...
    "ifpPageDescription" : MessageLookupByLibrary.simpleMessage("IFP Goodlift Calculator."),
    ...
    "ifpTotalWeight" : MessageLookupByLibrary.simpleMessage("Общий вес"),
    ...
    "mcCalf" : MessageLookupByLibrary.simpleMessage("Обхват голени"),
    "mcChest" : MessageLookupByLibrary.simpleMessage("Обхват груди"),
    ...
    "mcWrist" : MessageLookupByLibrary.simpleMessage("Обхват запястья"),
    "mcWristValidation" : MessageLookupByLibrary.simpleMessage("Введите обхват запястья."),
    "mcrobertMax" : MessageLookupByLibrary.simpleMessage("Максимум"),
    "mcrobertMin" : MessageLookupByLibrary.simpleMessage("Минимум"),
    "mcrobertPageDesc" : MessageLookupByLibrary.simpleMessage("Расчёт идеальных пропорций тела по МакРоберту для натурального бодибилдера."),
    "mcrobertPageTitle" : MessageLookupByLibrary.simpleMessage("Пропорциии тела (МакРоберт)"),
    ...
    "rmBarebellWeightValidation" : MessageLookupByLibrary.simpleMessage("Введите вес снаряда."),
